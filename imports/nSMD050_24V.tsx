...
export const nSMD050_24V = (props: ChipProps<typeof pinLabels>) => {
	return (
		<chip
			...
			cadModel={{
				objUrl:
					"https://modelcdn.tscircuit.com/easyeda_models/assets/C70076.obj?uuid=7dbd95a5ee9a45949b72cb8147e267ff",
				stepUrl:
					"https://modelcdn.tscircuit.com/easyeda_models/assets/C70076.step?uuid=7dbd95a5ee9a45949b72cb8147e267ff",
				pcbRotationOffset: 0,
